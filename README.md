[1. Платформа Java EE. Спецификации и их реализации](#1-платформа-java-ee-спецификации-и-их-реализации)
[2. Принципы IoC, CDI и Location Transpanency. Компоненты и контейнеры.](#1-платформа-java-ee-спецификации-и-их-реализации)
[1. Платформа Java EE. Спецификации и их реализации](#1-платформа-java-ee-спецификации-и-их-реализации)
[1. Платформа Java EE. Спецификации и их реализации](#1-платформа-java-ee-спецификации-и-их-реализации)
[1. Платформа Java EE. Спецификации и их реализации](#1-платформа-java-ee-спецификации-и-их-реализации)
[1. Платформа Java EE. Спецификации и их реализации](#1-платформа-java-ee-спецификации-и-их-реализации)
...
## 4. Java EE API(Спецификации). Виды компонентов. Профили платформы Java EE.  
...
## 14. React JS. Архитектура и основные принципы разработки приложений. arch
